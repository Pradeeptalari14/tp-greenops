# 🔧 Troubleshooting Guide — GreenOps Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-greenops/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/greenops/)
